...
## Function for conditioning on known data around.
source("../functions/condition_on_known.R")

## Function to show proportion of samples by scenario that fit the condition
source("../functions/proportion_allowed_by_condition.R")

## Filter by number of known cases on the 2nd of January
allowed_scenarios_3rd_jan <- scenario_sims %>% 
  condition_on_known(days_since_31st = 3, lower_bound = 40, upper_bound = 60)

## Total allowed samples by scenario
allowed_scenarios_3rd_jan %>% 
  proportion_allowed_by_condition(samples) %>% 
    knitr::kable()

## Filter by number of known cases on the 2nd of January
allowed_scenarios_20th_jan <- scenario_sims %>% 
    condition_on_known(days_since_31st = 20, lower_bound = 200, upper_bound = 240)

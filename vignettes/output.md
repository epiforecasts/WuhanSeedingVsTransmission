...
distribution once per model simulation with a lower bound and upper
bound determined by the scenario being evaluated. Generations were then
...
for R0, stratified by the transmission event size, transmission event
